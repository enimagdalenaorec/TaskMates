...
def mock_get_tasks_by_group(request):
    return Response({
        "tasks": [
        {"id": "1", "name": "Task1", "description": "description1", "points": "300", "maxCapacity": "3", "status": "full", "picture": "", "icon": None, "deadline": "2023-12-31", "members": [{"name": "Member1"}], "groupId": 1, "groupName": "Group1"},
        {"id": "2", "name": "Task2", "description": "description2", "points": "400", "maxCapacity": "2", "status": "available", "picture": "", "icon": None, "deadline": "2023-12-31", "members": [{"name": "Member2"}], "groupId": 1, "groupName": "Group1"},
        {"id": "3", "name": "Task3", "description": "description3", "points": "500", "maxCapacity": "4", "status": "finished", "picture": "", "icon": None, "deadline": "2023-11-30", "members": [{"name": "Member3"}], "groupId": 2, "groupName": "Group2"},
